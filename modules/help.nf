...
def helpMessage() {
    ...
    nucMACC specific options:
      ...
      --rawfilt_mono        [integer] Minimum number of reads mapping to a mono Nucleosome in order to count. (default: 30)
      --rawfilt_sub         [integer] Minimum number of reads mapping to a sub Nucleosome in order to count. (default: 5)
